...
// Official EXAMWAVE & Pankaj Kumar Ebooks Database
...
export const BOOKS = [
  ...
  // 2. UPSC EPFO Special Subject Notes Hindi
  {
  ...
  // 7. RRB JE Modern History 1000
  {
    ...
    title: "Modern Indian History & Culture Quick Study Guide",
    subtitle: "1000 MCQs Covering Freedom Movement, Art, Music & Heritage",
    tagline: "Useful for UPSC, State PSC & Railway Exams",
    category: "Competitive Exams",
    ...
    description: `Targeted history and culture handbook for competitive examinations.`,
    whoShouldRead: ["UPSC CSE and State PSC candidates."],
  ...
  // 13. Think on Paper by Pankaj Kumar
  {
    id: "think-on-paper",
    slug: "think-on-paper",
  ...
  // 14. Motion vs Action by Pankaj Kumar
  {
    id: "motion-vs-action",
  ...
  // 15. The Courage to Practice Freedom by Pankaj Kumar
  {
  ...
  // 16. Pragmatic AI for Business Leaders & Learners
  {
  ...
  // 17. Effective Study Habits Guide
  {
