...
const syncedAmazon = JSON.parse(fs.readFileSync('amazon_detailed_books_synced.json', 'utf8'));
...
const masterBooks = [
  // 1. UPSC EPFO Special Subject Notes by Pankaj Kumar
  {
    ...
    language: "English",
    fileFormats: ["PDF Digital", "EPUB Edition", "Kindle Edition"],
    fileSize: "3.28 MB",
    ...
    whatYoullLearn: ["GAAP principles", "Auditing vouching rules", "New 4 Labour Codes 2020"],
  ...
  // 2. UPSC EPFO Special Subject Notes Hindi Compiled
  {
    ...
    updatedDate: "2026-08-12",
    language: "Hindi",
    fileFormats: ["PDF Digital", "Kindle Edition"],
    fileSize: "6.51 MB",
    prices: { pdf: 149, usd: 1.99 },
  ...
  // 3. Crack UPSC EPFO/APFC 2026 Blueprint (B0H7661MLV)
  {
  ...
  // 4. Current Affairs Yearly MCQ 2025–2026 (B0GRMXQ5KT)
  {
    ...
    whoShouldRead: ["UPSC CSE 2026 candidates."],
    whatYoullLearn: ["12 months national & international news MCQs."],
    tableOfContents: [{ chapter: "Section 1", title: "Polity & Governance MCQs" }]
  },

  // 5. UPSC Prelims 2026 Current Affairs MCQs Best 300 (B0GRC4JY5R)
  {
    ...
    whoShouldRead: ["UPSC IAS Prelims 2026 candidates."],
    whatYoullLearn: ["January 2026 current affairs MCQs."],
    tableOfContents: [{ chapter: "Test 1", title: "Environment & Economy MCQs" }]
  },

  // 6. Indian Economy through MCQs 550 (B0FW3TPFWZ)
  {
    ...
    whoShouldRead: ["UPSC CSE & EPFO candidates."],
    whatYoullLearn: ["RBI monetary policy, Budget, Taxation."],
    tableOfContents: [{ chapter: "Module 1", title: "National Income Accounting" }]
  },

  // 7. Complete Geography Notes in Hindi (B0G2CFSVKK)
  {
    ...
    whoShouldRead: ["UPSC, State PSC एवं अन्य प्रतियोगी परीक्षाओं के छात्र।"],
    whatYoullLearn: ["भौतिक एवं भारत का भूगोल।"],
    tableOfContents: [{ chapter: "भाग 1", title: "भारत की नदियाँ एवं पर्वत" }]
  },

  // 8. Art & Culture 500 MCQs for UPSC EPFO/APFC (B0G1TVKL7J)
  {
    ...
    whoShouldRead: ["UPSC CSE, EPFO एवं State PCS के हिंदी अभ्यर्थी।"],
    whatYoullLearn: ["कला एवं संस्कृति MCQs."],
    tableOfContents: [{ chapter: "भाग 1", title: "स्थापत्य एवं वास्तुकला" }]
  },

  // 9. General Science 500+ MCQs (B0FTGFK4LR)
  {
    ...
    whoShouldRead: ["UPSC CSE & EPFO candidates."],
    whatYoullLearn: ["Physics, Chemistry & Biology MCQs."],
    tableOfContents: [{ chapter: "Module 1", title: "Physics & Everyday Science" }]
  },

  // 10. Static GK 5000 MCQs Part 1 (B0G15CJGH8)
  {
    ...
    whoShouldRead: ["सभी प्रतियोगी परीक्षाओं के अभ्यर्थी।"],
    whatYoullLearn: ["Static GK 5000 MCQs."],
    tableOfContents: [{ chapter: "भाग 1", title: "भारतीय इतिहास एवं राजव्यवस्था" }]
  },

  // 11. Master English Vocabulary 1000 Words (B0FV8X2MLB)
  {
    ...
    whoShouldRead: ["Aspirants aiming to improve English comprehension."],
    whatYoullLearn: ["1000 vocabulary words."],
    tableOfContents: [{ chapter: "Part 1", title: "High-Yield Editorial Words A-Z" }]
  },

  // 12. आधुनिक भारत Short Notes (B0G2MPT7YS)
  {
    ...
    whoShouldRead: ["UPSC CSE एवं State PCS के हिंदी अभ्यर्थी।"],
    whatYoullLearn: ["आधुनिक भारत का इतिहास।"],
    tableOfContents: [{ chapter: "भाग 1", title: "1857 का संग्राम एवं सामाजिक आंदोलन" }]
  },
...
const fileContent = `// Go Pustak — Master Ebooks Database
...
export const BOOKS = ${JSON.stringify(masterBooks, null, 2)};
`;

fs.writeFileSync('src/data/books.js', fileContent);
console.log('Successfully updated src/data/books.js with Amazon high-res covers & ASIN links!');
